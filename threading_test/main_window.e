...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			model.attach (Current)
			init_controller_thread
		end
...
feature --Observer
	...
	update
	do
		text_box.set_text(model.count.out)
		refresh_now
	end
	...
	do
		...
		thread.attach_command_channel(command_channel)
		thread.launch
	end
...
feature {NONE} -- Implementation
	...
	build_main_container
		...
		do
			text_box.set_text ("started!")
			main_container.extend (text_box)
		ensure
