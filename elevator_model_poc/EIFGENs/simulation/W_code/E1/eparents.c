...
/* ELEVATOR */
static EIF_TYPE_INDEX ptf860[] = {161,0xFFF7,864,0xFFFF};
static struct eif_par_types par860 = {860, ptf860, (uint16) 2, (uint16) 0, (char) 0};

/* APPLICATION */
static EIF_TYPE_INDEX ptf861[] = {161,0xFFFF};
